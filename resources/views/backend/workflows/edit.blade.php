                            ...
                            <form action="{{ route('workflows.update', $workflow->id) }}" method="POST">
                                    ...
                                    <select name="document_type_id" id="document_type_id"
                                        ...
                                        @foreach ($types as $type)
                                            <option value="{{ $type->id }}"
                                                {{ old('document_type_id', $workflow->document_type_id) == $type->id ? 'selected' : '' }}>
                                                {{ $type->nama }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="step_number" id="step_number"
                                        ...
                                        value="{{ old('step_number', $workflow->step_number) }}" required>
                                    @error('step_number')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="step_name" id="step_name"
                                        ...
                                        value="{{ old('step_name', $workflow->step_name) }}" required>
                                    @error('step_name')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="step_description" id="step_description" rows="3"
                                        class="form-control @error('step_description') is-invalid @enderror">{{ old('step_description', $workflow->step_description) }}</textarea>
