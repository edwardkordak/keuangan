@extends('layouts.app')
@section('title', 'Ganti Uang Persediaan')
@section('content')
    <main class="container my-5 flex-grow-1">
        ...
        <ul class="nav nav-tabs justify-content-center mb-4 border-0">
            <li class="nav-item">
                <a class="nav-link active fw-semibold px-4 py-2"
                    style="background-color: #293A6D; color: #fff; border-radius: 8px 8px 0 0;" href="{{ route('gup') }}">
                    GUP
                </a>
            </li>
            <li class="nav-item">
        ...
        <div class="d-flex justify-content-center mb-5">
            <form action="{{ route('gup.search') }}" method="GET"
        ...
        <div class="text-center">
            <div class="card shadow-sm border-0 rounded-4">
                <div class="card-body">
                    <img src="{{ asset('assets/img/GUP.png') }}" alt="Tracking Illustration"
                        class="img-fluid mx-auto d-block" style="max-width: 500px; height: auto;">
                    <p class="mt-3 text-muted">
                        Sistem pencarian dokumen <strong>GUP</strong> memudahkan Anda memonitor proses administrasi dengan
                        cepat dan akurat.
                    </p>
                </div>
            </div>
